...
| OZ-PKG-LNX-001 | `.deb`, systemd kullanıcı birimi, menü ve autostart | `dist/okul-zili_0.7.1_all.deb`; gömülü kütüphaneler `/usr/lib/okul-zili/vendor`, `md5sums` + `Installed-Size` | Paket içerik testi geçti; `python3-packaging` çakışması kaldırıldı; temiz Pardus/Ubuntu kurulumu bekliyor |
