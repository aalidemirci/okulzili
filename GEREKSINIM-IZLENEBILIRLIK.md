...
| OZ-PKG-LNX-001 | `.deb`, systemd kullanıcı birimi, menü ve autostart | `dist/okul-zili_0.7.0_all.deb` | Paket içerik testi geçti; arayüz bağımlılıkları (`customtkinter`, `darkdetect`, `packaging`) pakete gömülü; temiz Pardus/Ubuntu kurulumu bekliyor |
