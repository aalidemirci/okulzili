...
if (-not (Test-Path -LiteralPath $executable)) {
    ...
    foreach ($argument in @("--paket-kontrol", "--tepsi-kontrol", "--ilk-kurulum-kontrol", "--istisna-kontrol", "--baslangic-kontrol", "--giris-penceresi-kontrol", "--arayuz-kontrol", "--gozetimsiz-kontrol", "--ses-cihazi-kontrol")) {
