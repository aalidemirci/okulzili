...
`ayarlar.json` şema sürümü taşır. Yazma önce geçici dosyaya yapılır, disk eşitlemesinden sonra atomik değiştirme uygulanır ve önceki kopya `.bak` olarak korunur. v1/v2/v3/v4 yapılandırmaları v5 alanlarına göç ettirilir; mevcut olaylardan günün ders girdileri çıkarılır ve teneffüs müziği güvenli kapalı varsayılanla eklenir. Bilinmeyen ileri sürümler açılmaz.
